import { History, Target, Percent, TrendingUp } from 'lucide-react'
    ...
    <div className="bg-surface-container-low border border-surface-container-high rounded-xl p-5 shadow-sm stagger-in text-left space-y-5">
      ...
      <div>
        <div className="flex justify-between items-end mb-3">
          <div>
            <h4 className="text-sm font-bold text-on-surface">Deine Performance</h4>
            <p className="text-[10px] font-mono text-on-surface-variant uppercase tracking-wider mt-0.5">Saison-Verlauf & Trefferquote</p>
          </div>
          <div className="text-right">
            <span className="text-2xl font-black text-primary leading-none">{gesamtPunkte}</span>
            <span className="text-[10px] font-mono text-on-surface-variant ml-1">PKT</span>
          </div>
        </div>
        
        <div className="relative pt-2">
          <div className="flex justify-between text-[9px] font-mono text-on-surface-variant mb-1.5 px-1 items-end">
            <span>Bisher erreicht</span>
            <div className="text-right">
              <span className="text-primary-fixed-dim block">Noch {remainingPoints.total} Pkt möglich</span>
        ...
        <div className="space-y-3">
          <div className="bg-surface-container-lowest border border-surface-container-high rounded-lg p-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-[10px] text-on-surface-variant uppercase tracking-tight">Abgegebene Tipps</span>
            </div>
          ...
          <div className="bg-surface-container-lowest border border-surface-container-high rounded-lg p-3 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="font-mono text-[10px] text-on-surface-variant uppercase tracking-tight">Ø-Punkte</span>
            </div>
        ...
        <div className="bg-surface-container-lowest border border-surface-container-high rounded-lg p-3 flex flex-col justify-between">
          <div className="flex justify-between items-center mb-2">
            <div className="flex items-center gap-1.5">
              ...
              <span className="font-mono text-[10px] text-on-surface-variant uppercase tracking-tight">Verteilung</span>
            </div>
            <span className="font-mono text-[10px] font-bold text-emerald-400">{displayRate}% Treffer</span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-1.5 text-[9px] font-mono text-on-surface-variant uppercase leading-tight">
            <div className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-green-500 block shrink-0" /><span className="truncate">Exakt: <b className="text-on-surface">{stats.exact}</b></span></div>
            <div className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-amber-500 block shrink-0" /><span className="truncate">Diff: <b className="text-on-surface">{stats.diff}</b></span></div>
            <div className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-blue-500 block shrink-0" /><span className="truncate">Tend: <b className="text-on-surface">{stats.tend}</b></span></div>
            <div className="flex items-center gap-1.5"><span className="w-1.5 h-1.5 rounded-full bg-slate-600 block shrink-0" /><span className="truncate">Falsch: <b className="text-on-surface">{stats.miss}</b></span></div>
          </div>
        </div>
      </div>
    </div>
