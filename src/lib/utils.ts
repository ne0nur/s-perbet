...
export function calculateLevelDetails(punkte: number, achievementsCount: number = 0, bonusTippsCount: number = 0, achievementExpOverride?: number) {
  ...
  // Falls override gesetzt, nutze das; sonst fallback: 50 EXP pro Achievement
...
export function getRangTitelSystem(language: string) {
  ...
  return [
    { lvl: 1, title: 'Wasserholer', range: 'Lv. 1' },
    { lvl: 2, title: 'Çay-Bringer', range: 'Lv. 2' },
    { lvl: 3, title: 'Lellek', range: 'Lv. 3' },
    { lvl: 4, title: 'Alman-Tipper', range: 'Lv. 4' },
    { lvl: 5, title: 'Kreisliga-Bank', range: 'Lv. 5' },
    { lvl: 6, title: 'Balljunge', range: 'Lv. 6' },
    { lvl: 7, title: 'Schönwetter-Fan', range: 'Lv. 7' },
    { lvl: 8, title: 'Tipico-Spender', range: 'Lv. 8' },
    { lvl: 9, title: 'Kreisliga-Messi', range: 'Lv. 9' },
    { lvl: 10, title: 'Kreisklasse', range: 'Lv. 10' },
    { lvl: 11, title: 'Halbtags-Tipper', range: 'Lv. 11' },
    { lvl: 12, title: 'Tipico-Azubi', range: 'Lv. 12' },
    { lvl: 13, title: 'Stabil', range: 'Lv. 13' },
    { lvl: 14, title: 'Stammgast', range: 'Lv. 14' },
    { lvl: 15, title: 'Macher', range: 'Lv. 15' },
    { lvl: 16, title: 'Taktik-Fuchs', range: 'Lv. 16' },
    { lvl: 17, title: 'Ehrenmann', range: 'Lv. 17' },
    { lvl: 18, title: 'Chef-Analyst', range: 'Lv. 18' },
    { lvl: 19, title: 'Wett-Pate', range: 'Lv. 19' },
    { lvl: 20, title: 'Löwe', range: 'Lv. 20' },
    { lvl: 21, title: 'Speyer-Local', range: 'Lv. 21' },
    { lvl: 22, title: 'VIP-Tipper', range: 'Lv. 22' },
    { lvl: 23, title: 'Meister', range: 'Lv. 23' },
    { lvl: 24, title: 'Baba', range: 'Lv. 24' },
    { lvl: 25, title: 'Speyer-Patron', range: 'Lv. 25' },
    { lvl: 26, title: 'Maschine', range: 'Lv. 26' },
    { lvl: 27, title: 'Kral', range: 'Lv. 27' },
    { lvl: 28, title: 'Legende', range: 'Lv. 28' },
    { lvl: 29, title: 'Endgegner', range: 'Lv. 29' },
    { lvl: 30, title: 'Sechster Sinn', range: 'Lv. 30+' },
  ]
}
