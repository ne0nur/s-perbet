            ...
            {aktiveLiga.active_tournaments?.length > 1 && (
              <div className="flex bg-surface-container border border-surface-container-high p-1 rounded-lg mb-3 mx-4 md:mx-0 overflow-x-auto hide-scrollbar">
                ...
                {aktiveLiga.active_tournaments.map(t => (
                  ...
                  >
                    {t === 'Champions League' ? (
                      <img src="/logos/UEFA_Champions_League_logo.png" alt="CL" className="w-6 h-6 object-contain drop-shadow-[0_0_8px_rgba(255,255,255,0.6)] brightness-110" />
                    ) : t === 'Süper Lig' ? (
                      <img src="/logos/Süper_Lig.png" alt="SL" className="w-6 h-6 object-contain drop-shadow-[0_0_8px_rgba(255,255,255,0.6)] brightness-110" />
                    ) : null}
                    {t}
                  </button>
                ))}
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3 mb-6">
                ...
                >
                  ...
                  <img src="/logos/Süper_Lig.png" alt="SL" className="w-10 h-10 object-contain drop-shadow-[0_0_8px_rgba(255,255,255,0.6)] brightness-110 mb-3" />
                ...
                >
                  ...
                  <img src="/logos/UEFA_Champions_League_logo.png" alt="CL" className="w-10 h-10 object-contain drop-shadow-[0_0_8px_rgba(255,255,255,0.6)] brightness-110 mb-3" />
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      >
                        ...
                        <img src="/logos/Süper_Lig.png" alt="SL" className="w-8 h-8 object-contain drop-shadow-[0_0_8px_rgba(255,255,255,0.6)] brightness-110 mb-2" />
                      ...
                      >
                        ...
                        <img src="/logos/UEFA_Champions_League_logo.png" alt="CL" className="w-8 h-8 object-contain drop-shadow-[0_0_8px_rgba(255,255,255,0.6)] brightness-110 mb-2" />
                ...
                <div className="space-y-2 py-2">
                  ...
                  <label className="flex items-center gap-2 text-sm text-on-surface cursor-pointer bg-surface-container-lowest border border-surface-container-high p-2 rounded-lg">
                    <input type="checkbox" checked={neueLigaTurniere.includes('Süper Lig')} onChange={(e) => {
                      ...
                      else setNeueLigaTurniere(neueLigaTurniere.filter(t => t !== 'Süper Lig'))
                    }} className="accent-primary" /> Süper Lig
                  </label>
                  <label className="flex items-center gap-2 text-sm text-on-surface cursor-pointer bg-surface-container-lowest border border-surface-container-high p-2 rounded-lg">
                    <input type="checkbox" checked={neueLigaTurniere.includes('Champions League')} onChange={(e) => {
                      if (e.target.checked) setNeueLigaTurniere([...neueLigaTurniere, 'Champions League'])
                      else setNeueLigaTurniere(neueLigaTurniere.filter(t => t !== 'Champions League'))
                    }} className="accent-primary" /> Champions League
                  </label>
                </div>
                <button
